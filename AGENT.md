...
- `src/export_json.py`: Compiles SQLite into `data/{timeframe}/{timeframe}-{lang}.json` static API files atomically via `.tmp` directory.
...
- `trendshift.db`: Master SQLite database containing **69,200 snapshots** across **7,634 repositories**.
